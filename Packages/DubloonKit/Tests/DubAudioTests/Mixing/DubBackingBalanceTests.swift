...
struct DubBackingBalanceTests {
    ...
    /// The stretch of the scene a line covers.
    private func line(at start: TimeInterval, for duration: TimeInterval) -> Range<TimeInterval> {
    ...
    @Test func theBedIsMeasuredUnderTheLinesRatherThanBetweenThem() throws {
        ...
        let lines = [line(at: 0.1, for: 0.8), line(at: 2.1, for: 0.8)]
    ...
    @Test func theLevelUnderTheLinesIsAMedian() throws {
        ...
        let lines = (0..<5).map { line(at: Double($0) + 0.1, for: 0.8) }
    ...
    @Test func aLineOutsideTheBedIsIgnored() throws {
        ...
        let lines = [line(at: 0.1, for: 0.8), line(at: 10, for: 1)]
    ...
    @Test func aBedWithNoLinesOverItHasNoLevel() throws {
        ...
        #expect(DubBackingBalance.bedLevel(of: try bed(envelope: [0.3]), under: [line(at: 5, for: 1)]) == nil)
    }
