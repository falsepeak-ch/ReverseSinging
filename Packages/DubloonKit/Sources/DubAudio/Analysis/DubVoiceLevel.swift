...
public enum DubVoiceLevel {
    ...
    public static let strength: Float = 0.65
    ...
    public static let maximumBoost: Float = 3.2
    public static let maximumCut: Float = 0.32
    ...
    public static func speechLevel(of buffer: AVAudioPCMBuffer) -> Float? {
    ...
    public static func matchingGain(take: Float, reference: Float) -> Float {
    ...
    @discardableResult
    public static func match(_ take: AVAudioPCMBuffer, to reference: AVAudioPCMBuffer) -> Float {
    ...
    public static func match(_ take: AVAudioPCMBuffer, toReferenceAt url: URL) {
