...
public enum DubSpeechOnset {
    ...
    public static func leadIn(of buffer: AVAudioPCMBuffer) -> TimeInterval {
    ...
    public static func window(of buffer: AVAudioPCMBuffer) -> Window? {
