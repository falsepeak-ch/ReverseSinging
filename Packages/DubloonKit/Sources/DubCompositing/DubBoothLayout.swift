...
public struct DubBoothLayout: Equatable, Sendable {
    ...
    public static func fillTransform(displaySize: CGSize, into rect: CGRect) -> CGAffineTransform {
